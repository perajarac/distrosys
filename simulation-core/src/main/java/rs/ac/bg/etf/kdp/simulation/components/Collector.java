 ...
 *
 * <p>The Collector (typically component id 2) accumulates worker outputs until {@link #cnt} equals
 * {@link #m} (total body count), then merges all bodies and sends the combined state back to the
 * {@link Bag} (component id 1).
 */
public class Collector extends G {
   ...
   *
   * <p>When {@link #cnt} reaches {@link #m}, all bodies are merged into one {@link Field} and sent
   * to the Bag on component id 1, port 0.
   *
