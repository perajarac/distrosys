 ...
 *
 * <p>Loads a netlist, runs the selected simulator until the logical time reaches {@code endTime},
 * then writes component states via {@link NetlistWriter}.
 *
 * <p>Usage: {@code <komponente.txt> <veze.txt> <output.txt> <simType> <endTime>}
 */
public final class SimulationRunner {
   ...
   *
   * <ol>
   *   <li>components file path
   *   <li>connections file path
   *   <li>output file path
   *   <li>simulation type ({@link SimulationType#name()})
   *   <li>end time (exclusive upper bound for {@link Simulator#getlTime()})
   * </ol>
   *
