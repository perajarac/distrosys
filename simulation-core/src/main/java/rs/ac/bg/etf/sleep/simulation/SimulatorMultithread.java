...
/**
 * Multithreaded {@link Simulator} variant with time-window synchronization (partial
 * implementation).
 *
 * <p>Events outside the current time window are re-queued and {@link #synchronize()} is invoked
 * before retrying. Synchronization and time-range checks are not yet implemented.
 *
