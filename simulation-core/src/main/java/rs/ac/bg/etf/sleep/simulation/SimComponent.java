 ...
 *
 * <p>Components are registered in a {@link Netlist}, initialized via {@link #init()},
 * and driven by incoming {@link Event} messages. State can be serialized for
 * checkpointing and restored via {@link #restart(long)} during optimistic rollback.
 *
