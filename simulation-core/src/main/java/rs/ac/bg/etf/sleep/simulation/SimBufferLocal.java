...
/**
 * Local {@link SimBuffer} backed by a {@link PriorityQueue} ordered by {@link
...
public class SimBufferLocal<T> implements SimBuffer<T> {
   ...
   *
   * <p>Iterates the queue and removes matching events; behavior during concurrent modification of
   * the underlying queue is undefined.
   *
