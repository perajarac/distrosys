 ...
 *
 * <p>Used as a key when wiring connections in {@link Netlist} and when routing
...
public class SimEndpoint implements Serializable, Comparable<SimEndpoint> {
	...
	/** Creates an endpoint with unknown component and port ({@link #HOSTUNKNOWN}, {@link #PORTUNKNOWN}). */
	public SimEndpoint() {
	 ...
	 * @return negative, zero, or positive as this endpoint orders before, equal to, or after {@code arg}
	 */
