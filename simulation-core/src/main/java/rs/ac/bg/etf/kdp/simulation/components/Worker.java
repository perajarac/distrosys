 ...
 *
 * <p>Workers receive sharded {@link Field} work from the {@link Bag}, run {@link
 * Field#calculate()}, and send results to the {@link Collector} (component id 2).
 */
public class Worker extends G {
   ...
   *
   * <p>Ignores self-originated messages. Result is sent to component 2 on port {@code id - 1} at
   * logical time {@code lTime + field.interval}.
   *
