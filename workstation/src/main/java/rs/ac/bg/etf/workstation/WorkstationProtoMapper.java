...
public final class WorkstationProtoMapper {
   ...
   */
  public static List<ComponentState> toComponentStates(
      Netlist<?> netlist, List<String> componentLines) {
  ...
  public static Event<rs.ac.bg.etf.kdp.simulation.components.Field> toEvent(
    ...
    Event<rs.ac.bg.etf.kdp.simulation.components.Field> event =
        new Event<>(
  ...
  private static rs.ac.bg.etf.kdp.simulation.components.Body toCoreBody(Body body) {
    rs.ac.bg.etf.kdp.simulation.components.Body result =
        new rs.ac.bg.etf.kdp.simulation.components.Body();
