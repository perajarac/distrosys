...
public class WorkstationMain {
     ...
     *
     * @param args {@code <serverHost> <serverPort> <parallelism> [--headless] [--grpc-port PORT] [--grpc-host HOST]}
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String workstationId = serverClient.register(
        ...
        HeartbeatSender heartbeatSender = new HeartbeatSender(
                serverClient, state, config.getHeartbeatIntervalSec());
